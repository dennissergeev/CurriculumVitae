...
\begin{itemize}
\item Meteorology
\item Modelling Environmental Processes
\item Numerical Skills for Scientists
...
\begin{tabu} to \textwidth {p{\mycol}X[l]}
 2015--{\small Present} & \textbf{Python group coordinator} \\
& Managing an informal group of Python-users at University of East Anglia \\
& Website: \href{Python Group UEA}{http://ueapy.github.io} \\
\multicolumn{2}{c}{} \\
...
\begin{itemize}
        ...
        \item Polar Satellite Products for the Operational Forecaster: Microwave Analysis of Tropical Cyclones
